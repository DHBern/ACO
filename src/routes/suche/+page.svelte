 ...
 <div class="bg-gray-100-900 mx-auto flex flex-col gap-10 max-w-[1300px] p-5 py-8 shadow-md">
	...
	<div class={[!isInfoVisible && "hidden","mx-20 mt-5 mb-10"]}>
		...
		<ul class="list-disc ml-10">
			...
			<li class="text-base! mt-2"><strong>Asterisk (*)</strong>: Das Sternchen kann als Platzhalter für ein oder mehrere Wörter verwendet werden. Zum Beispiel: <code class="bg-secondary-500/20 font-bold">*gebärerin</code> sucht nach allen Wörtern, die auf "gebärerin" enden, wie "Christusgebärerin", "Gottesgebärerin" oder "Menschengebärerin".</li>
			<li class="text-base! mt-2"><strong>Konjunktive Termverbindung (AND)</strong>: Verwenden Sie das Wort "AND", um nach Dokumenten zu suchen, die beide Begriffe enthalten. Zum Beispiel: <code class="bg-secondary-500/20 font-bold">Nestorius AND Kyrill</code> sucht nach Dokumenten, die sowohl "Nestorius" als auch "Kyrill" enthalten.</li>
			<li class="text-base! mt-2"><strong>Disjunktive Termverbindung (OR)</strong>: Verwenden Sie das Wort "OR", um nach Dokumenten zu suchen, die mindestens einen der Begriffe enthalten. Zum Beispiel: <code class="bg-secondary-500/20 font-bold">Nestorius OR Kyrill</code> sucht nach Dokumenten, die entweder "Nestorius" oder "Kyrill" enthalten.</li>
		</ul>
